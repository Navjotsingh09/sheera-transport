        ...
        const widgetHTML = `
            ...
            <div class="whatsapp-widget" id="whatsapp-widget">
                ...
                <button class="whatsapp-button" id="whatsapp-button" aria-label="Open WhatsApp Chat">
                    <svg class="whatsapp-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    ...
                    <span class="whatsapp-badge" id="whatsapp-badge" aria-hidden="true">1</span>
                    <svg class="whatsapp-close-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
